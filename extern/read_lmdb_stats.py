...
lmdb_path = '/media/z1ko/2TM2/datasets/Assembly101/TSM/' #sys.argv[1]
output_folder = '/media/z1ko/2TM2/datasets/Assembly101/'
...
def save_statistic_input(views):
    ...
    with open(os.path.join(output_folder, 'assembly_statistics.pkl'), 'wb') as f:
        pkl.dump(total, f)
