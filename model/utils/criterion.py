...
if __name__ == '__main__':
    ...
    #ground_truth = torch.randint(0, 6, (10, 1000))
    #prediction = torch.rand((1, 10, 202, 1000))
    #
    #loss1 = CEplusMSE(3, 0.2)
    #loss2 = CEplusMSE2()
    #
    #a = loss1(prediction, ground_truth)
    #b = loss2(prediction, ground_truth)

    ground_truth = torch.randint(0, 6, (10, 1000))
    prediction = torch.randint(0, 6, (10, 1000))

    loss0 = F1Score(6)
    loss1 = F1Score2()

    a = loss0(prediction, ground_truth)
    loss1.add(prediction, ground_truth)
    b = loss1.summary()
